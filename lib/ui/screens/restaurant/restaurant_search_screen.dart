...
import 'package:finder/ui/screens/widgets/restaurant_mini_item.dart';
import 'package:finder/ui/screens/widgets/search_item.dart';
              ...
              children: <Widget>[
                Row(
                  children: <Widget>[
                    ...
                    SizedBox(width: 10),
                    Text(
                      "${restaurantProv.restaurantByKeywordList.length.toString()} finderran ditemukan",
                      style: TextStyle(
