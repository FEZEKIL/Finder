...
import 'package:finder/ui/screens/widgets/collection_item.dart';
import 'package:finder/ui/screens/widgets/restaurant_item.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        elevation: 0,
        backgroundColor: Colors.white,
        title: _appBar(), systemOverlayStyle: SystemUiOverlayStyle.dark,
      ),
      body: HomeBody(),
    );
  }
